...
public class RPSLSpock {
    ...
    /**
     * @param pick What moves are allowed
     * @return Return if the pick chosen is a valid choice
     */
    ...
    /**
     * @return Returns what the computer's choice
     */
     ...
     * @param h_pick The human's choice
     * @return Did the computer win
     */
